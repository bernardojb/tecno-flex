    ...
    <section class="about-area mt-5 mb-5">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <p class="mb-4 text-center">Flexível mono agrafado/grampeado, fabricado com fita de aço galvanizado
                        (MG-G),
                        zincado (MGZ) ou inox (MG-I). Oferece proteção mecânica de fios e cabos elétricos, além de
                        oferecer excelente flexibilidade e blindagem eletrostática.</p>
                </div>
            </div>
        </div>
        <div class="row align-items-center no-gutters mb-5">
            ...
            <div class="col-md-6 mb-5 mb-lg-0 position-relative">
                <img src="img/produtos/linha-eletrica/<?= $activePage; ?>2.jpg" class="img-fluid d-block m-auto"
