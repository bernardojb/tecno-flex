      ...
      <div class="row p-4">
        <div class="card p-4 mx-auto">
          <form action="login" method="post">
            <!-- <div class="px-4 pb-4"><img src="img/logo-bloomin.png" class="img-fluid" style="height:100px;width:auto;" alt="ACTBR" title="ACTBR"></div> -->
            ...
            <div class="form-group">
              <label>Senha:</label>
              <input type="password" class="form-control" name="password" data-eye>
            </div>
            <button type="submit" class="btn btn-primary btn-block">Login<i
                class="fas fa-sign-in-alt fa-fw ml-2"></i></button>
          </form>
          <hr class="mt-4">
