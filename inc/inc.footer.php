...
<footer class="footer-area area-padding-top">
   <div class="container">
      ...
      <div class="row footer-bottom d-flex justify-content-between">
         <p class="col-lg-4 col-sm-12 footer-text px-0">
            Tecno-Flex &copy;<?= date('Y'); ?> Todos os Direitos Reservados
         </p>
   ...
   <a href="https://api.whatsapp.com/send/?phone=5511944801963&text&type=phone_number&app_absent=0" target="_blank">
