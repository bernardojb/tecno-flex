        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <p class="mb-4 text-center">Proporciona plena fixação, rápida desmontagem e total
                        vedação quando fixado nas extremidades do flexível. Fabricado em latão laminado
                        zincado ou alumínio e fornecido com rosca tipo BSP ou tipo NPT. Pode ser fixo (TMF,
                        TFF) ou giratório (TMG, TFG). A contra porca (TCP) é utilizada nos terminais machos
                        para restringir o deslocamento da ancoragem ou da emenda.</p>
                </div>
            </div>
        </div>
